...
![*choco--version*](./images/choco-v.png "choco version")
...
![*Terminal*](./images/windows-terminal-about.png "Terminal")
...
![*IDE-vs-about*](./images/IDE-vs-about.png "IDE-vs-about")
...
![*git-v*](./images/git-v.png "git --version")
...
```
![*git-config*](./images/git-config-cred.png "git-config-cred")
...
![*vbox --version*](./images/vbox-v.png "vbox --version")
...
![*vagrant --version*](./images/vagrant-v.png "vagant --version")
...
![*packer --version*](./images/packer-v.png "packer --version")
...
![*oh-my-git-game-intro*](./images/oh-my-git-game-intro.png "oh-my-git-game-intro")

![*oh-my-git-game-workingtogether-commit*](./images/oh-my-git-game-workingtogether-commit.png "oh-my-git-game-workingtogether-commit")

![*oh-my-git-game-workingtogether-push*](./images/oh-my-git-game-workingtogether-push.png "oh-my-git-game-workingtogether-push")
