...
![emp count & schema](./images/Part%20I_count_schema.png "emp count & schema")
...
![emp status count](./images/Part%20II_empstatus_count.png "emp status count")

![modified emp table](./images/Part%20II_modified_emp_table.png "modified emp table")

![Error output](./images/Part%20II_error_output.png "Error output")
...
![db output](./images/Part%20III_db_output.png "db output")
